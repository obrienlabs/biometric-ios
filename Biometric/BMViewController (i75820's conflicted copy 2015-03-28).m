...
//static NSString * const cloudURLPrivateString = @"http://biometric-dev.elasticbeanstalk.com/FrontController?action=setGps";//&u=20131027&lt=0&lg=0&al=0&hr=99
//static NSString * const cloudURLPrivateString = @"http://192.168.0.12:8080/biometric/FrontController?action=setGps";//
static NSString * const cloudURLPrivateString = @"http://biometric-dev.elasticbeanstalk.com/FrontController?action=setGps";//
